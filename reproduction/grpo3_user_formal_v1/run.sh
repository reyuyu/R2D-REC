...
ROOT="${GRPO3_FORMAL_ROOT:-/root/grpo3_user_formal_200_20260906}"
SOURCE="$ROOT/source"
RUNS="$ROOT/runs"
...
RUN_ID="GRPO3-USER-CONTINUED-GRPO2-STEP250-LR3E7-200"
RUN_DIR="$RUNS/$RUN_ID"
...
CONFIG="$USER_DIR/configs/grpo3_user_from_grpo2_step250_formal_v1.json"
...
write_state PREFLIGHT "validating selected parent, registered data, source and four GPUs"
...
write_state TRAINING "four-GPU candidate-parallel DDP, K=4, 200 prompts"
export CUDA_VISIBLE_DEVICES=0,1,2,3
...
write_state TRAINING_AND_USER_PROBES_COMPLETE "official Overall score and Recommendation retention remain pending"
trap - ERR
