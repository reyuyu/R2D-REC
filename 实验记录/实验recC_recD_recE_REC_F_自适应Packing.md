...
### 实验 RECF（checkpoint-3500）

```text
总分：1.2027
物料四域：0.0454, 0.0374, 0.0395, 0.0433
用户两项：0.1550, 0.0993
推荐四域：0.1101, 0.1428, 0.1680, 0.1359
world：0.2260
```

### 实验 RECF（checkpoint-5718）

```text
总分：1.2246
物料四域：0.0441, 0.0376, 0.0420, 0.0425
用户两项：0.1577, 0.1006
推荐四域：0.1055, 0.1496, 0.1792, 0.1386
world：0.2271
```
