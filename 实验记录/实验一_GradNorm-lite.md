...
### 实验 A：Lagged GradNorm-lite

### checkpoint-1000

总分：`1.0448`

| 评测部分 | 子项 1 | 子项 2 | 子项 3 | 子项 4 |
| --- | ---: | ---: | ---: | ---: |
| 懂物料（4 个域） | 0.0037 | 0.0164 | 0.0021 | 0.0000 |
| 懂用户（2 个问题） | 0.1310 | 0.0846 | - | - |
| 懂推荐（4 个域） | 0.0915 | 0.1598 | 0.1820 | 0.1440 |
| 懂世界 | 0.2297 | - | - | - |
...
| 评测部分 | 子项 1 | 子项 2 | 子项 3 | 子项 4 |
| --- | ---: | ---: | ---: | ---: |
| 懂物料（4 个域） | 0.0032 | 0.0000 | 0.0047 | 0.0000 |
| 懂用户（2 个问题） | 0.1476 | 0.0922 | - | - |
| 懂推荐（4 个域） | 0.0691 | 0.1802 | 0.1694 | 0.1422 |
| 懂世界 | 0.2316 | - | - | - |

排除懂物料后的可比较分数：`1.0323`。

> 备注：以上两个 checkpoint 的懂物料评分均不具备参考意义。

### rank16 基础实验参考

基础实验未启用实验 A 的动态梯度控制，用作相同 rank16 设置下的参考基线。
...
| 评测部分 | 子项 1 | 子项 2 | 子项 3 | 子项 4 |
| --- | ---: | ---: | ---: | ---: |
| 懂物料（4 个域） | 0.0035 | 0.0156 | 0.0008 | 0.0000 |
| 懂用户（2 个问题） | 0.1309 | 0.0874 | - | - |
| 懂推荐（4 个域） | 0.0896 | 0.1564 | 0.1708 | 0.1458 |
| 懂世界 | 0.2260 | - | - | - |
...
| 评测部分 | 子项 1 | 子项 2 | 子项 3 | 子项 4 |
| --- | ---: | ---: | ---: | ---: |
| 懂物料（4 个域） | 0.0038 | 0.0051 | 0.0038 | 0.0000 |
| 懂用户（2 个问题） | 0.1442 | 0.0951 | - | - |
| 懂推荐（4 个域） | 0.0756 | 0.1734 | 0.1722 | 0.1413 |
| 懂世界 | 0.2312 | - | - | - |
...
| 评测部分 | 子项 1 | 子项 2 | 子项 3 | 子项 4 |
| --- | ---: | ---: | ---: | ---: |
| 懂物料（4 个域） | 0.0013 | 0.0041 | 0.0026 | 0.0000 |
| 懂用户（2 个问题） | 0.1483 | 0.1003 | - | - |
| 懂推荐（4 个域） | 0.0821 | 0.1768 | 0.1708 | 0.1431 |
| 懂世界 | 0.2342 | - | - | - |

排除懂物料后的可比较分数：`1.0556`。

> 备注：基础实验三个 checkpoint 的懂物料评分同样不具备参考意义。

### 横向对比（排除懂物料）

| checkpoint | 实验 A | rank16 基础实验 | 实验 A - 基础实验 |
| --- | ---: | ---: | ---: |
| 1000 | 1.0226 | 1.0069 | +0.0157 |
| 2500 | 1.0323 | 1.0330 | -0.0007 |
| 5200 | 待评测 | 1.0556 | - |
