...
2026-08-04???? A0-v2?`learning_rate=1.0e-4`?`lora_dropout=0.01`?????????????????????????????????????

????? A0-v2 ??????????????? `v1_thought_prompt`??? COT ??? `v2_recommendation_cot_complete`?40,821 ?????? gradient checkpointing ??? 27/36 ??ratio `0.75`??????????? A ??

| ??? | ?? A0-v2 | ?? A0-v2 ?? |
| --- | ---: | ---: |
| `learning_rate` | `1.0e-4` | `2.0e-4` |
| `lora_dropout` | `0.01` | `0.05` |
| ???? | `...gc75_lr1e4_dropout001...` | `...gc75_lr2e4_dropout005...` |

????????????rank 16?alpha 32?FlashAttention-2?`balanced_40`??? 8 microbatch?Lagged GradNorm-lite?world ?????Ortho ? Action auxiliary ????seed 42?5200 macro-step????????? v1/v2 ????? GC 0.75 ???????????/? dropout?????????

???`configs/onereason/onereason_lora_2gpu_balanced40_r16_gradnorm_a0_v2_think_prompt_recommendation_cot_complete_gc75_lr2e4_dropout005.yaml`
