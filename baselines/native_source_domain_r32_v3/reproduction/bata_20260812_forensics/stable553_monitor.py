...
const f=(v,n=6)=>v==null?'—':Number(v).toFixed(n);let state=null,smoothN=1,view={min:0,max:25,auto:true},drag=null;const downloadStates={};
...
function setDownloadState(label,patch){downloadStates[label]={...(downloadStates[label]||{}),...patch};renderRuns()}
