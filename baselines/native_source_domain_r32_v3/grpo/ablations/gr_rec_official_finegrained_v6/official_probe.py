...
from .official_finegrained_trainer import extract_history_sids, reward_level
...
class FineGrainedOfficialProbeEvaluator(FixedProbeEvaluator):
    """Enrich the unchanged production Probe with passive copy diagnostics."""
