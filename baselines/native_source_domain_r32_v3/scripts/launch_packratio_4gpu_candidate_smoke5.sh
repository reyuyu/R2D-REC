...
CONFIG_PATH="${BASELINE_ROOT}/config/train_rec_pu_beta_material_aligned_r32_b005_2epoch_packratio_20452015_candidate_smoke5.yaml"
LOG_DIR="/data/logs/baselines/native_source_domain_r32_v3/PACKRATIO-20452015-4GPU-CANDIDATE-SMOKE5"
