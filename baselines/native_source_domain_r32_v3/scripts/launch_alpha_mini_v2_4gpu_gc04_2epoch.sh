...
RUN_ID="${RUN_ID:-ALPHA-MINI-V2-R32-2E-GC04-4GPU-$(date +%Y%m%d-%H%M%S)}"
SOURCE_CONFIG="${BASELINE_ROOT}/config/train_alpha_mini_v2_4gpu_gc04_2epoch.yaml"
DATASET_ROOT="/data/lf_data_versions/alltrain/mini_v2"
