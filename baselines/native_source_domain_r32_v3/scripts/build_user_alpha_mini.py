#!/usr/bin/env python3
"""Build a stratified alpha_mini understand-user task pool."""
...
ACTION_TARGETS = {"1-5": 180, "6-10": 240, "11-20": 360, "21-30": 240, "31-40": 120, "41+": 60}
CHAIN_COT_TARGETS = {"2": 30, "3": 110, "4": 50, "5+": 10}
CHAIN_NOCOT_TARGETS = {"2": 90, "3": 330, "4": 150, "5+": 30}
...
def main() -> None:
    ...
    output_dir = Path("/data/lf_data_versions/task_pools") / "\u61c2\u7528\u6237" / "alpha_mini"
    ...
    file_hashes["understand_user_alpha_mini.jsonl"] = write_jsonl(output_dir / "understand_user_alpha_mini.jsonl", merged)
