...
RUN_ID="${RUN_ID:-BETA-MATERIAL-ALIGNED-SID8-R32-2E-GC04-4GPU-$(date +%Y%m%d-%H%M%S)}"
DATASET_ROOT="/data/lf_data_versions/alltrain/BETA_material_aligned_v1"
SOURCE_CONFIG="${BASELINE_ROOT}/config/train_beta_material_aligned_sid8_4gpu_gc04_2epoch.yaml"
