...
RUN_ID="${RUN_ID:-MINI-FIX-U3K-R32-2E-GC04-4GPU-$(date +%Y%m%d-%H%M%S)}"
SOURCE_CONFIG="${BASELINE_ROOT}/config/train_mini_fix_u3k_4gpu_gc04_2epoch.yaml"
DATASET_ROOT="/data/lf_data_versions/alltrain/mini_fix_u3k"
